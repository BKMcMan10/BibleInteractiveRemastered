...
int main()
{
	...
	// Generates shaders
	ShaderClass shaderProgram("assets/shaders/default.vert", "assets/shaders/default.frag");
	ShaderClass framebufferProgram("assets/shaders/framebuffer.vert", "assets/shaders/framebuffer.frag");
	ShaderClass shadowMapProgram("assets/shaders/shadowMap.vert", "assets/shaders/shadowMap.frag");
	ShaderClass shadowCubeMapProgram("assets/shaders/shadowCubeMap.vert", "assets/shaders/shadowCubeMap.frag", "assets/shaders/shadowCubeMap.geom");
	...
	Shader modelShader("assets/shaders/mesh.vs", "assets/shaders/mesh.fs");

	const std::string& tablePath = "resources/objects/backpack/backpack.obj";

	StaticModel table("assets/models/backpack/backpack.obj");
