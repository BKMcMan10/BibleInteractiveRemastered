...
public:
    ...
    // constructor
    MeshM(vector<VertexM> vertices, vector<unsigned int> indices, vector<TextureM> textures)
    {
...
private:
    ...
    void setupMesh()
    {
        ...
        glVertexAttribIPointer(5, 4, GL_INT, sizeof(VertexM), (void*)offsetof(VertexM, m_BoneIDs));

        // weights
        glEnableVertexAttribArray(6);
        glVertexAttribPointer(6, 4, GL_FLOAT, GL_FALSE, sizeof(VertexM), (void*)offsetof(VertexM, m_Weights));
        glBindVertexArray(0);
    }
};
